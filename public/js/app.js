...
const NAV = [
  ...
  { name: 'templates', label: 'قوالب المستندات', icon: icon.palette(), perm: 'invoices.view' },
  { name: 'template-builder', label: 'إنشاء القوالب', icon: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><path d="M8 13h2"/><path d="M8 17h8"/><path d="M10 9H8"/></svg>`, perm: 'invoices.view' },
