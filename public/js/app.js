...
const NAV = [
  ...
  { name: 'dashboard', label: 'لوحة المعلومات', icon: icon.dashboard(), perm: 'reports.view' },
  ...
  { name: 'bulk', label: 'التوليد الدفعي الذكي', icon: icon.bulk(), perm: 'bulk.generate' },
  ...
  { name: 'templates', label: 'قوالب الفواتير', icon: icon.palette(), perm: 'invoices.view' },
  ...
  { name: 'reports', label: 'التقارير', icon: icon.report(), perm: 'reports.view' },
      ...
      <div class="main">
        <header class="topbar">
          ...
          <div class="issuer-pick">
            <label for="issuer-select">الشركة المصدرة النشطة</label>
