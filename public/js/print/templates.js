...
export const INVOICE_TEMPLATES = [
  ...
  {
    id: 're_awtad_albadr',
    name: 'الحرة وأوتاد البدر (لوجستيات وتوريد)',
    desc: 'قالب مستخرج بدقة ومطابق لترويسة شركة الحرة المتحدة للخدمات اللوجستية وتوريدات أوتاد البدر الفندقية.',
    badge: 'عينة re',
    category: 'a4',
  ...
  },
  {
    ...
    name: 'رواسي ينبع (اتصالات وأجهزة)',
    desc: 'مستخرج من فاتورة مؤسسة رواسي ينبع للاتصالات مع السيريال والفرع والبيع الآجل للأجهزة الذكية.',
    badge: 'عينة re',
    category: 'a4',
  ...
  },
  {
    ...
    name: 'الزهراني والمجد (مقاولات وحديد)',
    desc: 'مستخرج من فاتورة الزهراني والمجد مع مستودع خميس مشيط وأمر الشراء وتاريخ الاستحقاق.',
    badge: 'عينة re',
    category: 'a4',
