...
function issuerForm(data = {}) {
  ...
  return html`
    ...
    <div data-panel="address" class="hidden">
      <div class="row">
        <div class="field"><label>الشارع</label><input type="text" name="street" value="${v('street')}" /></div>
      ...
      <div class="row mt">
        <div class="field"><label>الحي</label><input type="text" name="district" value="${v('district')}" /></div>
      ...
      <div class="alert alert-info mt">العنوان الوطني مطلوب في الفاتورة الضريبية المتوافقة مع متطلبات هيئة الزكاة والضريبة والجمارك.</div>
    </div>
